...
namespace ITsynch.Trainings.Demo.Template
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = "../ITsynch.Trainings.Demo.Template.Client/dist";
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSpa(spa =>
            {
                ...
                spa.Options.SourcePath = "../ITsynch.Trainings.Demo.Template.Client";
